...
def test_mini_project_2():
    ...
    # id -> name -> class name -> link/partial -> tag name -> css selector -> xpath.
    ...
    time.sleep(3)  # This is super bad practice - Python Int to stop - Webdriver to stop for the element
